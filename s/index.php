...
<head>
	...
	<!-- Compressed Styles -->
	<link href="C:\wamp64\www\s\css\custom1.css" rel="stylesheet" type="text/css">
	...
	<!-- Compressed Scripts -->
	<script src="C:\wamp64\www\s\js\slides.min.js" type="text/javascript"></script>
...
<nav class="panel top">
  <div class="sections desktop">
    <div class="left"><img src="C:\wamp64\www\s\assets\img\ll2.png"></img></div>
    <div class="center">
      <ul class="menu">
    ...
    <div class="right"><a class="button blue gradient" href="#">Kontakt</a><a class="button green gradient" href="#">E-mail</a></div>
  </div>
  
  <div class="sections compact hidden">
    <div class="left"><img src="C:\wamp64\www\s\assets\img\ll.png" width=82px height=24px></img></div>
...
<section class="slide fade-6 kenBurns">
        ...
        <div class="fix-12-12">
          <ul class="flex fixedSpaces verticalCenter reverse">
            <li class="col-6-12 left middle">
              <h1 class="ae-1 fromLeft">Ihr Call Center outsourcing Partner!.</h1>
              <p class="ae-2 fromLeft"><span class="opacity-8">Outsourcing von Call-Center-Dienstleistungen ermöglicht es Unternehmen, sich auf ihre Kernkompetenzen zu konzentrieren, während Experten sich um die Kundenkommunikation kümmern. Es spart Kosten.</span></p>
              <a class="button blue gradient ae-3 fromCenter cropLeft">Ring a</a><a class="button white ae-4 fromCenter">prO</a>
            </li>
            <li class="col-6-12 right middle">
              <img class="ae-4" src="C:\wamp64\www\s\assets\img\logo1111.png" data-action="zoom"/>
            </li>
          </ul>
        </div>
  ...
  <div class="background" style="background-image:url(C:\wamp64\www\s\assets\img\bg\img-34.jpg)"></div>
</section>
        ...
        <div class="fix-12-12">
          <ul class="grid">
            <li class="col-6-12 left">
              <h1 class="ae-2 fromLeft">Unsere Starken</h1>
              <p class="ae-3 fromLeft"><span class="opacity-8">Kleine Unternehmen haben grundzatlich bessere quallitat als die gorossen konkurenten</span></p>
              <ul class="tabs controller uppercase bold ae-4 fromCenter" data-slider-id="60-1">
                <li class="selected">Kunden service</li>
                <li>Verkauf</li>
                <li>E-Mail und chat</li>
              </ul>
            </li>
              ...
              <ul class="slider animated margin-top-4" data-slider-id="60-1">
                <li class="selected fromCenter">
                  <div class="popupTrigger shadow rounded" data-popup-id="60-1">
                    <img class="wide" src="C:\wamp64\www\s\assets\img\dd.png" alt="Video Thumbnail"/>
                  </div>
                </li>
                <li class="fromCenter">
                  <div class="popupTrigger shadow rounded" data-popup-id="60-2">
                    <img class="wide" src="C:\wamp64\www\s\assets\img\vv.png" alt="Video Thumbnail"/>
                  </div>
                </li>
                <li class="fromCenter">
                  <div class="popupTrigger shadow rounded" data-popup-id="60-3">
                    <img class="wide" src="C:\wamp64\www\s\assets\img\tt.png" alt="Video Thumbnail"/>
                  </div>
                </li>
              </ul>
            </li>
            ...
            <li class="col-5-12 cell-27">
              <div class="fix-4-12">
                <ul class="slider clickable ae-1 fromAbove" data-slider-id="27-2">
                  ...
                  <li><img src="assets/img/watch-26-1.png" /></li>
